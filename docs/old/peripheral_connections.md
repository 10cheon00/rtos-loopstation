...
이 문서는 STM32H743VIT6, LQFP100 패키지 기준의 1차 배선 계획이다. 이전 문서의 STM32 연결 컬럼은 잘못된 핀아웃을 바탕으로 작성되었으므로 사용하지 않는다. 아래 연결은 `../references/stm32h743vi.pdf`의 STM32H742/H743 데이터시트 DS12110 Rev 11, Table 9 pin/ball definition과 Table 10 alternate functions를 기준으로 다시 정리했다.
...
- STMicroelectronics, `STM32H742xI/G STM32H743xI/G` datasheet DS12110 Rev 11, January 2026: `../references/stm32h743vi.pdf`
