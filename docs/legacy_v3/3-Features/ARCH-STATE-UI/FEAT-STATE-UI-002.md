...
| 항목 | 내용 |
| --- | --- |
| 기능 ID | `FEAT-STATE-UI-002` |
| 상위 설계 문서 | `ARCH-STATE-UI.md` |
| 관련 설계 항목 | `ARCH-STATE-UI-002` |
...
| --- | --- | --- |
| `ARCH-STATE-UI-002` | 패널 context | `selected_item`, `selected_track`, `selected_fx_bus`를 context에 보관한다. |
...
| 출력 | 설명 |
| --- | --- |
| UI state context | 선택 정보를 보관하는 context |
...
| 설계 추적 | 구현과 시험이 `ARCH-STATE-UI-002`의 설계 결정을 만족하는지 검토한다. |
