...
| 항목 | 내용 |
| --- | --- |
| 기능 ID | `FEAT-STATE-UI-015` |
| 상위 설계 문서 | `ARCH-STATE-UI.md` |
| 관련 설계 항목 | `ARCH-STATE-UI-015` |
...
| --- | --- | --- |
| `ARCH-STATE-UI-015` | parent panel mapping | 각 하위 panel state 등록 정보에 parent panel을 둔다. |
...
| 설계 추적 | 구현과 시험이 `ARCH-STATE-UI-015`의 설계 결정을 만족하는지 검토한다. |
