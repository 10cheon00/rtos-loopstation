...
| 항목 | 내용 |
| --- | --- |
| 기능 ID | `FEAT-STATE-DISPLAY-022` |
| 상위 설계 문서 | `ARCH-STATE-DISPLAY.md` |
| 관련 설계 항목 | `ARCH-STATE-DISPLAY-022` |
...
| --- | --- | --- |
| `ARCH-STATE-DISPLAY-022` | 직접 진입 parent | 두 FX 설정 패널의 parent panel을 `FX`로 유지한다. |
...
| 설계 추적 | 구현과 시험이 `ARCH-STATE-DISPLAY-022`의 설계 결정을 만족하는지 검토한다. |
