...
| 항목 | 내용 |
| --- | --- |
| 기능 ID | `FEAT-STATE-DISPLAY-007` |
| 상위 설계 문서 | `ARCH-STATE-DISPLAY.md` |
| 관련 설계 항목 | `ARCH-STATE-DISPLAY-007` |
| 관련 요구사항 | `REQ-STATE-DISPLAY-002, REQ-STATE-DISPLAY-004, REQ-STATE-DISPLAY-006` |
...
| --- | --- | --- |
| `ARCH-STATE-DISPLAY-007` | 우 조작 전이 | `SETTING -> HOME`, `HOME -> FX`, `FX -> TRACK`을 정의한다. |
...
| 설계 추적 | 구현과 시험이 `ARCH-STATE-DISPLAY-007`의 설계 결정을 만족하는지 검토한다. |
