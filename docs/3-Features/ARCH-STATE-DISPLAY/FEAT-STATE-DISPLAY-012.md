...
| 항목 | 내용 |
| --- | --- |
| 기능 ID | `FEAT-STATE-DISPLAY-012` |
| 상위 설계 문서 | `ARCH-STATE-DISPLAY.md` |
| 관련 설계 항목 | `ARCH-STATE-DISPLAY-012` |
| 관련 요구사항 | `REQ-STATE-DISPLAY-009` |
...
| --- | --- | --- |
| `ARCH-STATE-DISPLAY-012` | FX 하위 패널 | IFX는 `IFX_SETTING`, TFX는 `TFX_SETTING`으로 전이한다. |
...
| 설계 추적 | 구현과 시험이 `ARCH-STATE-DISPLAY-012`의 설계 결정을 만족하는지 검토한다. |
