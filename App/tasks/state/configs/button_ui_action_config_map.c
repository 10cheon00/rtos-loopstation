...
static ConfigMapEntry button_ui_action_config_map_entries[] = {
...
static ConfigMap button_ui_action_map = {
    .count = ARRAY_COUNT(button_ui_action_config_map_entries),
    .entries = button_ui_action_config_map_entries,
};

ConfigValidator_REGISTER(&button_ui_action_map, ButtonId, UiActionId);

UiActionId ButtonUiActionConfigMap_Get(UiActionId id)
{
    Value_t value;
