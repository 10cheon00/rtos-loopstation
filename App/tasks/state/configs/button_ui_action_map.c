...
ButtonUiActionMapEntry button_ui_action_map[] = {
    ...
    {.button_id = BUTTON_ID_ENCODER_A_PUSH, .ui_action_id = UI_ACTION_ENTER_ENCODER_A},
    {.button_id = BUTTON_ID_ENCODER_B_PUSH, .ui_action_id = UI_ACTION_ENTER_ENCODER_B},
    {.button_id = BUTTON_ID_ENCODER_C_PUSH, .ui_action_id = UI_ACTION_ENTER_ENCODER_C},
    {.button_id = BUTTON_ID_ENCODER_D_PUSH, .ui_action_id = UI_ACTION_ENTER_ENCODER_D},
