...
#define ENTRIES                                                             \
  ConfigTable_1D_ENTRY(BUTTON_ID_NONE, TRACK_ACTION_ID_NONE),               \
      ...
      ConfigTable_1D_ENTRY(BUTTON_ID_TRACK_1_PLAY_RECORD,                   \
                           TRACK_ACTION_ID_ENTER_RECORD_PLAY),              \
      ConfigTable_1D_ENTRY(BUTTON_ID_TRACK_1_STOP,                          \
                           TRACK_ACTION_ID_ENTER_STOP),                     \
      ConfigTable_1D_ENTRY(BUTTON_ID_TRACK_2_EDIT, TRACK_ACTION_ID_NULL),   \
      ConfigTable_1D_ENTRY(BUTTON_ID_TRACK_2_PLAY_RECORD,                   \
                           TRACK_ACTION_ID_ENTER_RECORD_PLAY),              \
      ConfigTable_1D_ENTRY(BUTTON_ID_TRACK_2_STOP,                          \
                           TRACK_ACTION_ID_ENTER_STOP),                     \
      ConfigTable_1D_ENTRY(BUTTON_ID_TRACK_3_EDIT, TRACK_ACTION_ID_NULL),   \
      ConfigTable_1D_ENTRY(BUTTON_ID_TRACK_3_PLAY_RECORD,                   \
                           TRACK_ACTION_ID_ENTER_RECORD_PLAY),              \
      ConfigTable_1D_ENTRY(BUTTON_ID_TRACK_3_STOP,                          \
                           TRACK_ACTION_ID_ENTER_STOP),                     \
      ConfigTable_1D_ENTRY(BUTTON_ID_TRACK_4_EDIT, TRACK_ACTION_ID_NULL),   \
      ConfigTable_1D_ENTRY(BUTTON_ID_TRACK_4_PLAY_RECORD,                   \
                           TRACK_ACTION_ID_ENTER_RECORD_PLAY),              \
      ConfigTable_1D_ENTRY(BUTTON_ID_TRACK_4_STOP,                          \
                           TRACK_ACTION_ID_ENTER_STOP),                     \
      ConfigTable_1D_ENTRY(BUTTON_ID_TRACK_5_EDIT, TRACK_ACTION_ID_NULL),   \
      ConfigTable_1D_ENTRY(BUTTON_ID_TRACK_5_PLAY_RECORD,                   \
                           TRACK_ACTION_ID_ENTER_RECORD_PLAY),              \
...
ConfigValidator_REGISTER_CONFIG_TABLE_1D(ButtonId, TrackActionId,
                                         BUTTON_ID_COUNT, TRACK_ACTION_ID_NONE,
