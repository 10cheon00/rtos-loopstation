...
ControlButtonIdUiActionIdMapping control_button_id_ui_action_id_mapping[] = {
    {
    ...
    },
    {
        ...
        .ui_action_id = UI_ACTION_NAVIGATE_RIGHT
    },
    {
        .control_button_id = CONTROL_BUTTON_ID_ENTER,
        .ui_action_id = UI_ACTION_ENTER
    },
    {
        .control_button_id = CONTROL_BUTTON_ID_EXIT,
        .ui_action_id = UI_ACTION_EXIT
    },
    {
        .control_button_id = CONTROL_BUTTON_ID_IFX_A_TOGGLE,
        .ui_action_id = UI_ACTION_TO_IFX
    },
    {
        .control_button_id = CONTROL_BUTTON_ID_TFX_A_TOGGLE,
        .ui_action_id = UI_ACTION_TO_TFX
    }
};

size_t control_button_id_ui_action_id_mapping_count = ARRAY_COUNT(control_button_id_ui_action_id_mapping);
