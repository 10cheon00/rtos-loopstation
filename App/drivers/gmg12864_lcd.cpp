...
{
    return (params != 0) &&
           (params->hspi != NULL && params->CS_Pin != 0 && params->CS_Port != NULL &&
                                                    ...
                                                    void *arg_ptr)
{
    ...
    case U8X8_MSG_GPIO_CS:
        HAL_GPIO_WritePin(params->CS_Port, params->CS_Pin, arg_int ? GPIO_PIN_SET : GPIO_PIN_RESET);
        break;
    case U8X8_MSG_GPIO_DC:
        HAL_GPIO_WritePin(params->DC_Port, params->DC_Pin, arg_int ? GPIO_PIN_SET : GPIO_PIN_RESET);
        break;
    default:
        return 0;
    }
...
Gmg12864LcdStatus Gmg12864Lcd_Init(u8g2_t *u8g2, Gmg12864Lcd_InitParams *params)
{
    ...
    u8g2_Setup_st7565_erc12864_alt_f(u8g2, U8G2_R0, Gmg12864Lcd_u8g2MessageCallback,
