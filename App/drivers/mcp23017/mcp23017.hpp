...
class Mcp23017Driver {
 ...
 public:
  ...
  Mcp23017Status GetMcp23017AddressFromInterruptPin(
      Mcp23017InterruptPin gpio_interrupt_pin, Mcp23017Address* address);
  Mcp23017Status UpdateLedState(Mcp23017Address address,
                                Mcp23017GpioId led_gpio_id,
                                Mcp23017LedState led_state);
 ...
 private:
  ...
  Mcp23017Status ReadRegister(Mcp23017Address address, uint8_t reg,
                              uint8_t* value);
  Mcp23017Status WriteRegister(Mcp23017Address address, uint8_t reg,
                               uint8_t value);
  Mcp23017Status UpdateLedStateLocked(Mcp23017Address address,
                                      Mcp23017GpioId led_gpio_id,
                                      Mcp23017LedState led_state);
};
...
//     Mcp23017Status GetMcp23017AddressFromInterruptPin(Mcp23017InterruptPin
//     gpio_interrupt_pin,
//                                                       Mcp23017Address
//                                                       *address);
//     Mcp23017Status GetInterruptSnapshot(Mcp23017Address address,
//     Mcp23017InterruptSnapshot *state);
...
//     Mcp23017Status UpdateLedState(Mcp23017Address address, Mcp23017GpioId
//     led_gpio_id,
//                                   Mcp23017LedState led_state);
