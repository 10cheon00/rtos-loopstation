...
static constexpr const PinConfigMap pin_config_map{
    ...
    EnumEntry{GpioId::BUTTON_ENCODER_B_PUSH,
              PinConfig{
                  .gpio_type = GpioType::INPUT,
                  .address = Address::b100,
                  .port = Port::A,
    ...
    EnumEntry{GpioId::BUTTON_ENCODER_C_PUSH,
              PinConfig{
                  .gpio_type = GpioType::INPUT,
                  .address = Address::b100,
                  .port = Port::B,
    ...
    EnumEntry{GpioId::BUTTON_ENCODER_D_PUSH,
              PinConfig{
                  .gpio_type = GpioType::INPUT,
                  .address = Address::b100,
                  .port = Port::B,
    ...
    EnumEntry{GpioId::BUTTON_SETTING,
              PinConfig{
                  .gpio_type = GpioType::INPUT,
                  .address = Address::b100,
                  .port = Port::A,
